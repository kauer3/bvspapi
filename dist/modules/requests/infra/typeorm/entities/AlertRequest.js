...
let AlertRequest = (_dec = (0, _typeorm.Entity)('alert_requests'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.ManyToOne)(() => _Request.default), _dec7 = (0, _typeorm.JoinColumn)({
  name: 'request_id'
}), _dec8 = Reflect.metadata("design:type", typeof _Request.default === "undefined" ? Object : _Request.default), _dec9 = (0, _typeorm.Column)(), _dec10 = Reflect.metadata("design:type", String), _dec11 = (0, _typeorm.ManyToOne)(() => _User.default), _dec12 = (0, _typeorm.JoinColumn)({
  name: 'user_id'
}), _dec13 = Reflect.metadata("design:type", typeof _Request.default === "undefined" ? Object : _Request.default), _dec14 = (0, _typeorm.Column)(), _dec15 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec16 = (0, _typeorm.CreateDateColumn)(), _dec17 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec18 = (0, _typeorm.UpdateDateColumn)(), _dec19 = Reflect.metadata("design:type", typeof Date === "undefined" ? Object : Date), _dec(_class = (_class2 = (_temp = class AlertRequest {
  constructor() {
    ...
    _initializerDefineProperty(this, "moment", _descriptor6, this);
  ...
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "moment", [_dec14, _dec15], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
