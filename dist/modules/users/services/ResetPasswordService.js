...
class ResetPasswordService {
  ...
  async execute({
    ...
    user.accesscode = await this.hashProvider.generateHash(password); // alguns usuários podem ainda não ter um país, pois antes, não tinha.

    if (!user.country) user.country = 'Brasil';
